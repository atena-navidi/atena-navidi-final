  ...
  return (
    <section className="container mx-auto px-4 my-12 max-w-297">
      <div className="flex flex-col md:flex-row">
        <div
          className="w-full md:w-2/3 bg-[#28A745] flex md:flex-row items-center justify-between p-5 text-white
        ...
        <div
          className="w-full md:w-1/3 bg-white border border-gray-200 shadow-sm flex flex-col items-center justify-center gap-4 p-6
